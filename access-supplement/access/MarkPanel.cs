...
{
    public class MarkPanel : IClickableMenu
    {
        private ModConfig Config;

        public MarkPanel(ModConfig config) : base((int)GetMenuPosition().X, (int)GetMenuPosition().Y, 600 + IClickableMenu.borderWidth * 2, 100 + IClickableMenu.borderWidth * 2 + 64)
        {
            this.Config = config;
        }
